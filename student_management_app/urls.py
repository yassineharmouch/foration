...
urlpatterns = [
    ...
    path('add_fouration/', HodViews.add_fouration, name="add_fouration"),
    path('add_fouration_save/', HodViews.add_fouration_save, name="add_fouration_save"),
    path('manage_fouration/', HodViews.manage_fouration, name="manage_fouration"),
    path('edit_fouration/<fouration_id>/', HodViews.edit_fouration, name="edit_fouration"),
    path('edit_fouration_save/', HodViews.edit_fouration_save, name="edit_fouration_save"),
    path('delete_fouration/<fouration_id>/', HodViews.delete_fouration, name="delete_fouration"),
